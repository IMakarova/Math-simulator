...
export const operationAction = (operationNumbers, operationMark) => (dispatch, getState) => {
    dispatch({ 
      type: OPERATIONS_ACTION_TYPES.OPERATION,
...
export const nextOperationAction = (operationNumbers) => (dispatch, getState) => {
    dispatch({ 
      type: OPERATIONS_ACTION_TYPES.NEXT_OPERATION, 
...
// export const quizAction = (operationNumbers) => (dispatch, getState) => {
//   dispatch({ 
...
export const getResultAction = (result) => (dispatch, getState) => {
  dispatch({ 
    type: OPERATIONS_ACTION_TYPES.GET_RESULT, 
    payload: { result }
  })
};
